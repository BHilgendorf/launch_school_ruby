...
def calculate_total(hand)
  ...
  hand.select { |key, value| value == 11 }.count.times do
...
def hit_or_stay(player_choice)
  ...
  loop do
    ...
    break if player_choice == 's' || player_choice == 'h'
...
display_hands(player_hand, player_total, dealer_hand.first, dealer_hand.first[1])
...
if busted?(player_total) 
  puts "You have busted. It is now the dealers turn"
else 
  puts "Player has chosen to 'stay'. It is now the dealer's turn"
end
...
puts ""
puts "#{winner} the winner of this hand"

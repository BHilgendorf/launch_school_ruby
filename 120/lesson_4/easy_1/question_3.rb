...
# Answer: The go_fast method uses string interpolastion with self.class 
# This calls the .class method on "self" or the object that is calling the
# .class method. In this case it is Car

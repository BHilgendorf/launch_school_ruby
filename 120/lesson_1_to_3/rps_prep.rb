#structure of the game after the first go round of walk throughs
...
#outlined in the initial stucture, but not used in the first walkthrough
# class Move
#   def initialize
#     #
#   end
...
#Need an "engine" to orchestrate the objects.
